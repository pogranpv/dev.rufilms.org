...
<div class="baseform" style="margin-left:10px;">
	<table class="tableform">
		<tr>
			<td colspan="2">
	[registration]
			<h4>Здравствуйте, уважаемый посетитель нашего сайта!</h4><br />
	...
	[registration]
		<tr>
			...
			<td>
				<input type="text" name="name" id='name' style="width:175px; margin-right: 10px; float:left;" class="f_input" /><input class="reg-b" style="height: 20px; font-size: 11px;" title="Проверить доступность логина для регистрации" onclick="CheckLogin(); return false;" type="button" value="Проверить имя" />
