...
if( $do_template == '' or ! $do_template ) {
	...
	$show_delete_link = "<a class=\"btn btn-red\" href=\"$PHP_SELF?mod=templates&subaction=delete&user_hash={$dle_login_hash}&do_template=$do_template\">$lang[opt_dellink]</a>";
}
  ...
  <div class="box-content">
	...
	<div class="row box-section">	
		 <div class="form-group">
		  ...
		  <div class="col-lg-10"><form method="post" action="{$PHP_SELF}?mod=templates">
...
echo <<<HTML
	...
	<div class="row box-section">	
		 <div class="form-group">
		  ...
		  <div class="col-lg-10"><form method="post" action="{$PHP_SELF}?mod=templates"><select class="uniform" name="do_template">
HTML;
...
echo <<<HTML
		...
		<div class="row box-section">
			 <div class="form-group">
			  ...
			  <div class="col-lg-10">
				<a class="btn btn-green" href="{$PHP_SELF}?mod=templates&subaction=new&action=templates&user_hash={$dle_login_hash}">{$lang['opt_enewtepl']}</a>&nbsp;
				{$show_delete_link}
			  </div>
			</div>
		</div>
