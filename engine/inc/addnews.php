...
<div class="box">
			...
			<form method="post" name="addnews" id="addnews" onsubmit="if(checkxf()=='fail') return false;" action="{$PHP_SELF}" class="form-horizontal">
                     ...
                     <div class="tab-pane active" id="tabhome">
						<div class="row box-section">
							...
							<div class="form-group">
							 ...
							 <div class="form-group">
							  <label class="control-label col-lg-2">{$lang['addnews_date']}</label>
							  <div class="col-lg-10">
...
{$output}
							<div class="form-group">
							  ...
							  <div class="col-lg-10">
								  <div class="row">
									<div class="col-lg-12"><input class="icheck" type="checkbox" id="approve" name="approve" value="1" checked><label for="approve">{$lang['addnews_mod']}</label></div>
								  </div>
								  <div class="row">
									<div class="col-lg-3" style="max-width:300px;" >{$main_input}</div>
									<div class="col-lg-3" style="max-width:250px;"><input class="icheck" type="checkbox" id="allow_comm" name="allow_comm" value="1" checked><label for="allow_comm">{$lang['addnews_comm']}</label></div>
									<div class="col-lg-6">{$disable_index}</div>
								  </div>
								  <div class="row">
									<div class="col-lg-3" style="max-width:300px;" ><input class="icheck" type="checkbox" id="allow_rating" name="allow_rating" value="1" checked><label for="allow_rating">{$lang['addnews_allow_rate']}</label></div>
