...
function popupedit( name ){
		...
		$('#dleuserpopup').dialog({
			...
			open: function(event, ui) {
				$("#dleuserpopup").html("<iframe name='edituserframe' id='edituserframe' width='100%' height='389' src='{$PHP_SELF}?mod=editusers&action=edituser&user=" + name + "&rndval=" + rndval + "' frameborder='0' marginwidth='0' marginheight='0' allowtransparency='true'></iframe>");
			},
                 ...
                 <div class="tab-content">
                     <div class="tab-pane active" id="tabhome">
						<div class="row box-section">
							...
							<div class="form-group">
							  <label class="control-label col-lg-2">{$lang['edit_info']}</label>
							  <div class="col-lg-10">
							...
							<div class="form-group">
							  <label class="control-label col-lg-2">{$lang['edit_edate']}</label>
							  <div class="col-lg-10">
...
{$output}
							...
							<div class="form-group">
							  <label class="control-label col-lg-2">{$lang['news_edit_reason']}</label>
							  <div class="col-lg-10">
							...
							<div class="form-group">
							  <label class="control-label col-lg-2">{$lang['addnews_option']}</label>
							  <div class="col-lg-10">
								  <div class="row">
									<div class="col-lg-12"><input class="icheck" type="checkbox" id="approve" name="approve" value="1" {$ifapp}><label for="approve">{$lang['addnews_mod']}</label></div>
								  </div>
								  <div class="row">
									<div class="col-lg-3" style="max-width:300px;" >{$main_input}</div>
									<div class="col-lg-3" style="max-width:250px;"><input class="icheck" type="checkbox" id="allow_comm" name="allow_comm" value="1" {$ifch}><label for="allow_comm">{$lang['addnews_comm']}</label></div>
									<div class="col-lg-6">{$disable_index}</div>
								  </div>
								  <div class="row">
									<div class="col-lg-3" style="max-width:300px;" ><input class="icheck" type="checkbox" id="allow_rating" name="allow_rating" value="1" {$ifrat}><label for="allow_rating">{$lang['addnews_allow_rate']}</label></div>
									<div class="col-lg-3" style="max-width:250px;">{$fix_input}</div>
                    ...
                    <div class="tab-pane" id="tabvote" >
						<div class="row box-section">
							...
							<div class="form-group">
							  <label class="control-label col-lg-2">{$lang['v_ftitle']}</label>
							  <div class="col-lg-10">
							...
							<div class="form-group">
							  <label class="control-label col-lg-2">{$lang['vote_body']}<div class="note large">{$lang['vote_str_1']}</div></label>
							  <div class="col-lg-10">
                    ...
                    <div class="tab-pane" id="tabextra" >
						<div class="row box-section">
							...
							<div class="form-group">
							  <label class="control-label col-lg-2">{$lang['catalog_url']}</label>
							  <div class="col-lg-10">
							...
							<div class="form-group">
							  <label class="control-label col-lg-2">{$lang['addnews_url']}</label>
							  <div class="col-lg-10">
							...
							<div class="form-group">
							  <label class="control-label col-lg-2">{$lang['addnews_tags']}</label>
							  <div class="col-lg-10">
	...
	if( $member_id['user_group'] < 3 ) {
		foreach ( $user_group as $group ) {
			if( $group['id'] > 1 ) {
				echo <<<HTML
							<div class="form-group">
							  <label class="control-label col-lg-2">{$group['group_name']}</label>
							  <div class="col-lg-10">
...
echo <<<HTML
	...
	{$notice_btn}
	{$spam_btn}
	<button onclick="confirmDelete('$PHP_SELF?mod=editnews&action=doeditnews&ifdelete=yes&id=$id&user_hash=$dle_login_hash', '{$id}'); return false;" class="btn btn-red"><i class="icon-trash"></i> {$lang['edit_dnews']}</button>
