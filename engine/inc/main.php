	...
	<div class="row box-section">	
	  <div class="col-md-6">
		<div class="news with-icons">
		  ...
		  <div class="news-content">
			<div class="news-title"><a href="$PHP_SELF?mod=editusers&action=list">{$lang['opt_user']}</a></div>
			<div class="news-text">
			  <a href="$PHP_SELF?mod=editusers&action=list">{$lang['opt_userc']}</a>
			</div>
		  </div>
		</div>
	  </div>
	  <div class="col-md-6">
		<div class="news with-icons">
		  ...
		  <div class="news-content">
			<div class="news-title"><a href="$PHP_SELF?mod=banners">{$lang['opt_banner']}</a></div>
			<div class="news-text">
			  <a href="$PHP_SELF?mod=banners">{$lang['opt_bannerc']}</a>
			</div>
		  </div>
		</div>
	  </div>
	...
	<div class="row box-section">
	  <div class="col-md-6">
		<div class="news with-icons">
		  ...
		  <div class="news-content">
			<div class="news-title"><a href="$PHP_SELF?mod=options&action=syscon">{$lang['opt_all']}</a></div>
			<div class="news-text">
			  <a href="$PHP_SELF?mod=options&action=syscon">{$lang['opt_allc']}</a>
			</div>
		  </div>
		</div>
	  </div>
	  <div class="col-md-6">
		<div class="news with-icons">
		  ...
		  <div class="news-content">
			<div class="news-title"><a href="$PHP_SELF?mod=newsletter">{$lang['main_newsl']}</a></div>
			<div class="news-text">
			  <a href="$PHP_SELF?mod=newsletter">{$lang['main_newslc']}</a>
			</div>
		  </div>
		</div>
	  </div>
	...
	<div class="row box-section">
	  <div class="col-md-6">
		<div class="news with-icons">
		  ...
		  <div class="news-content">
			<div class="news-title"><a href="$PHP_SELF?mod=static">{$lang['opt_static']}</a></div>
			<div class="news-text">
			  <a href="$PHP_SELF?mod=static">{$lang['opt_staticd']}</a>
			</div>
		  </div>
		</div>
	  </div>
	  <div class="col-md-6">
		<div class="news with-icons">
		  ...
		  <div class="news-content">
			<div class="news-title"><a href="$PHP_SELF?mod=clean">{$lang['opt_clean']}</a></div>
			<div class="news-text">
			  <a href="$PHP_SELF?mod=clean">{$lang['opt_cleanc']}</a>
			</div>
		  </div>
		</div>
	  </div>
	...
	<div class="row box-section">
	  ...
	  <div class="col-md-6">
		<div class="news with-icons">
		  ...
		  <div class="news-content">
			<div class="news-title"><a href="$PHP_SELF?mod=options&action=options">{$lang['opt_all_rublik']}</a></div>
			<div class="news-text">
			  <a href="$PHP_SELF?mod=options&action=options">{$lang['opt_all_rublikc']}</a>
			</div>
		  </div>
		</div>
	  </div>
