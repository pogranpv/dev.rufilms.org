...
if( $action == "list" ) {
	...
	while ( $row = $db->get_array() ) {
        ...
        <td><a title=\"{$lang[edit_static_act]}\" class=\"tip status-info\" href=\"$PHP_SELF?mod=static&action=doedit&id={$row['id']}\">$descr</a></td>
...
<div class="box">
  ...
  <div class="box-content">
	...
	<div class="row box-section">
		<input type="button" value="{$lang['static_new']}" class="btn btn-blue" onclick="document.location='$PHP_SELF?mod=static&action=addnew'">
	</div>
  </div>
</div>
HTML;
...
<div class="box-footer padded">
		  ...
		  <div class="pull-right"><input type="button" value="{$lang['static_new']}" class="btn btn-blue" onclick="document.location='$PHP_SELF?mod=static&action=addnew'"> <select name="action" class="uniform">
...
<div class="box">
  ...
  <div class="box-content">
	...
	<div class="row box-section">
		...
		<div class="form-group">
		  <label class="control-label col-lg-2">{$lang['static_title']}</label>
		  <div class="col-lg-10">
			<input type="text" name="name" size="25">&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_stitle']}" >?</span>
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-lg-2">{$lang['static_descr']}</label>
		  <div class="col-lg-10">
...
HTML;
	...
	echo <<<HTML
		...
		<div class="form-group">
		  <label class="control-label col-lg-2">{$lang['static_type']}</label>
		  <div class="col-lg-10">
			{$fix_br}
		  </div>
		 </div>	
		...
		<div class="form-group">
		  ...
		  <div class="col-lg-10">
			<input type="text" name="descr" id="autodescr" style="width:100%;max-width:400px;"> <i class="icon-warning-sign"></i> {$lang['meta_descr_max']}</span>
		  </div>
		 </div>	
		<div class="form-group">
...
HTML;
		...
		<div class="form-group">
		  <label class="control-label col-lg-2">{$lang['static_title']}</label>
		  <div class="col-lg-10">
			<input type="text" name="name" size="25" value="{$row['name']}">&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_stitle']}" >?</span>
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-lg-2">{$lang['static_descr']}</label>
...
HTML;
	...
	echo <<<HTML
		...
		<div class="form-group">
		  <label class="control-label col-lg-2">{$lang['meta_descr']}</label>
		  <div class="col-lg-10">
			<input type="text" name="descr" id="autodescr" style="width:100%;max-width:400px;" value="{$row['metadescr']}"> <i class="icon-warning-sign"></i> {$lang['meta_descr_max']}</span>
		  </div>
		 </div>	
		<div class="form-group">
		  <label class="control-label col-lg-2">{$lang['meta_keys']}</label>
